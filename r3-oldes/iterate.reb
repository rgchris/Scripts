Rebol [
    ...
    Purpose: "Rudimentary Iterator API; Core Iterators"

    Home: https://github.com/rgchris/Scripts
    Rights: https://opensource.org/licenses/Apache-2.0

    Type: module
    Name: rgchris.iterator
    Exports: [
        iterate iterators
    ]
...
iterators: context [
    dom: context [
        ...
        next: func [
            ...
            walker/event: case [
                ...
                ; initial state
                ;
                empty? walker/parents [
                    insert/only walker/path walker/node

                    insert/only walker/parents any [
                        walker/node/3 []
                    ]
                ...
                (
                    walker/parents/1: skip walker/parents/1 1
                    string? walker/node: first back walker/parents/1
                ) [
                    'text
                ]
                ...
                block? walker/node/3 [
                    insert/only walker/path walker/node
                    insert/only walker/parents walker/node/3
        ...
        close: func [
            ...
            walker/parents/1: tail walker/parents/1
        ]
            ...
            while [continue?] [
                case [
                    ...
                    <else> [
                        ...
                        either need <= length-of value/buffer/1 [
                            ...
                            need: need - length-of value/buffer/1
                            value/buffer: skip value/buffer 1
                        ]
                    ]
                ]
            ...
            walker/event: either empty? walker/parents [
                ...
                either tail? walker/parents/2 [
                    ...
                    either empty? walker/parents [
                        ...
                        walker/type: type-of/word walker/value
                    ...
                    if any [
                        object? walker/parents/1
                        map? walker/parents/1
                    ][
                        walker/name: walker/value
                        walker/value: select walker/parents/1 walker/name
                    ]

                    switch/default walker/type: type-of/word walker/value [
                        block!
                        paren! [
                        ...
                        map! [
                            insert walker/parents reduce [
                                walker/value keys-of walker/value
                                ; original value, working value
                            ]
    ...
    folders: context [
        ...
        new: func [
            ...
            walker: make map! reduce prototype
            ...
            case [
                ...
                tail? walker/parents/1 [
                    ...
                    either empty? walker/parents [
                        ...
                        walker/path: find/match/tail walker/full walker/root
